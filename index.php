...
<section class="container mt-n4 mb-5">
    <div class="bg-white p-4 shadow-sm rounded-4 border">
        ...
        <div class="d-flex overflow-auto pb-2 gap-3" style="scrollbar-width: none; -ms-overflow-style: none;">
            <?php
            // Updated links to match your 'categories' table slugs or IDs
            $upcoming = [
                ['name' => 'AFCAT I 2026', 'link' => 'afcat'],
                ['name' => 'Railway Group D', 'link' => 'railway'],
                ['name' => 'SSC MTS 2025', 'link' => 'ssc'],
                ['name' => 'RRB ALP CBT-1', 'link' => 'railway'],
                ['name' => 'DSSSB PRT 2025', 'link' => 'teaching'],
                ['name' => 'GATE ME 2026', 'link' => 'engineering'],
                ['name' => 'CTET 2025 Paper I', 'link' => 'teaching']
            ];
            
            foreach($upcoming as $ex) {
                // Now links to the dynamic view-mocks page with the category filter
                echo "
                <a href='exam/view-mocks.php?cat={$ex['link']}' class='text-decoration-none'>
                    <div class='flex-shrink-0 bg-light border rounded-3 px-4 py-2 text-dark fw-bold whitespace-nowrap' style='min-width: 180px; text-align: center; transition: 0.3s;'>
...
<style>
    /* Adding a subtle hover effect to make the slider items feel interactive */
...
<section class="container mb-5">
    ...
    <div class="row g-4">
        <?php
        // 1. ADDED 'id' to each test to match your database
        $popular_tests = [
            ['id' => 3, 'title' => 'AFCAT I 2026', 'mock' => 'Mock Test-2', 'q' => '100', 'm' => '300', 't' => '120'],
            ['id' => 2, 'title' => 'SSC CGL Tier-1', 'mock' => 'Full Test-5', 'q' => '100', 'm' => '200', 't' => '60'],
            ['id' => 4, 'title' => 'SBI PO Prelims', 'mock' => 'Practice Set-1', 'q' => '100', 'm' => '100', 't' => '60']
        ];
        ...
        foreach($popular_tests as $pt) {
            ...
            <div class='col-md-4'>
                <div class='card border-0 shadow-sm rounded-4 p-3 position-relative overflow-hidden'>
                    ...
                    <a href='exam/take_test.php?id={$pt['id']}' class='btn btn-primary w-100 rounded-pill fw-bold'>Start Test</a>
                </div>
            </div>";
        }
        ?>
...
<section class="container my-5">
    <div class="bg-white p-5 shadow-sm rounded-4 border">
        <h2 class="fw-bold mb-4">Mastering Competitive Exams in 2026: A Strategic Approach</h2>
        <div class="row g-4">
            <div class="col-md-6">
                <h4 class="text-primary fw-bold">Why Practice with Mock Tests?</h4>
                <p class="text-muted" style="line-height: 1.8;">
                    In 2026, the pattern for exams like <strong>SSC CGL</strong> and <strong>IBPS PO</strong> has shifted toward complex logical reasoning and high-speed data interpretation. Attempting our <strong>free mock tests</strong> helps you simulate the real exam environment, manage your time effectively, and understand the negative marking scheme.
                </p>
            </div>
            <div class="col-md-6">
                <h4 class="text-primary fw-bold">Analyzing the SSC MTS 2025 Pattern</h4>
                <p class="text-muted" style="line-height: 1.8;">
                    The <strong>SSC MTS 2025</strong> focuses on two sessions. While Session 1 (Math/Reasoning) is qualifying, Session 2 (GK/English) determines your merit. Our detailed subject-wise questions help you master every topic from ancient history to advanced arithmetic.
                </p>
            </div>
        </div>
        
        <div class="mt-5 p-4 bg-primary-subtle rounded-4 border-start border-4 border-primary">
            <h5 class="fw-bold"><i class="fas fa-info-circle me-2"></i> AdSense Compliance Tip</h5>
            <p class="mb-0 small">This site provides free educational resources. Our content is designed by subject matter experts to help students improve accuracy and speed in national-level competitive examinations.</p>
        </div>
    </div>
</section>
